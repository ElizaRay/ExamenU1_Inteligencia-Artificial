...
#Sensar colores mediante la camara 
#Rango y colo para sensar
#                    H  S  V
#Hue 0 al 180
#Saturacion 0 a 255
#Brillo 0 a 255
...
colorfi = np.array([0,255,255],np.uint8)
...
#Usando Bitwise para mostrar imagen con color detectando como mascara
